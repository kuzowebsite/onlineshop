  ...
  return (
    <div className="grid min-h-screen w-full lg:grid-cols-[280px_1fr]">
      ...
      <div className="flex flex-col">
        <AdminHeader title="Шинэ бүтээгдэхүүн нэмэх" />
                          ...
                          >
                            ...
                            <SelectContent>
                              {categories.length > 0 ? (
                                ...
                                <div className="p-2 text-sm text-center text-muted-foreground">Ангилал олдсонгүй</div>
                              )}
                            </SelectContent>
                          </Select>
                          {categories.length === 0 && (
                            <p className="text-xs text-muted-foreground mt-1">
                              <Link href="/admin/categories/add" className="text-rose-600 hover:underline">
                                Шинэ ангилал нэмэх
                              </Link>
                            </p>
                          )}
                          ...
                          <Select value={formData.store} onValueChange={(value) => handleSelectChange("store", value)}>
                            ...
                            <SelectContent>
                              {stores.length > 0 ? (
                                ...
                                <div className="p-2 text-sm text-center text-muted-foreground">Дэлгүүр олдсонгүй</div>
                              )}
                            </SelectContent>
                          </Select>
                          {stores.length === 0 && (
                            <p className="text-xs text-muted-foreground mt-1">
                              <Link href="/admin/stores/add" className="text-rose-600 hover:underline">
                                Шинэ дэлгүүр нэмэх
                              </Link>
                            </p>
                          )}
